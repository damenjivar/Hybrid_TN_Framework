...
public class ExcelCode {
	...
	// 3. Copy the Excel sheet and put it inside the package where you want to keep
	// your code
	// 4. Make sure the Excel sheet is updated, then only paste it as mentioned in
	// point 3
	...
	public static Object[][] readFromExcelSheetTNLogin(String sheetName) throws Exception {
		// 5. Create the Object of FileInputStream class and pass the path of the Excel
		// sheet in its Constructor
		ip = new FileInputStream(System.getProperty("user.dir")
				+ "\\src\\test\\java\\com\\tutorialsninja\\qa\\TestData\\ExcelData.xlsx");
